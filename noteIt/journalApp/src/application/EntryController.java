...
public class EntryController extends SceneController implements Initializable {
	...
	public JournalEntryModel journalEntryModel = new JournalEntryModel();
	...
	public void Save(ActionEvent event) {
		...
		try {
			...
			if(!journalEntryModel.getStatus()) {
				journalEntryModel.createEntry(title.getText(), dateTime, entry.getText());
			} else {
				System.out.println("Preparing to update entry.");
				journalEntryModel.updateEntry(title.getText(), dateTime, entry.getText(),
						id);
			}
	...
	public void setStatus(boolean isBeingUpdated) {
		journalEntryModel.setStatus(isBeingUpdated);
	}
